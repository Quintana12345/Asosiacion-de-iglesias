...
$defaults = [
    'titulo' => '',
    'descripcion' => '',
    'fecha_inicio' => date('Y-m-d') . ' 09:00',
    'fecha_fin' => date('Y-m-d') . ' 18:00',
    'ubicacion' => '',
    'comision_id' => '',
    'zona_id' => '',
    'sector_id' => '',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $creador_id = $_SESSION['user_id'] ?? 1; // ID del usuario actual
        ...
        if (empty($titulo)) {
            ...
            // Insertar evento según estructura real de la tabla
            $stmt = $db->prepare("INSERT INTO eventos 
                (titulo, descripcion, fecha_inicio, fecha_fin, ubicacion, 
                 comision_id, zona_id, sector_id, creador_id, estado, fecha_creacion) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())");
            ...
            $id = $db->lastInsertId();
            $_SESSION['success_msg'] = 'Evento creado exitosamente';
...
<head>
    ...
    <title>Crear Evento - <?php echo SITE_NAME; ?></title>
    ...
    <div class="main-content">
        ...
        <div class="content-container">
            ...
            <div class="page-header">
                ...
                <p>Complete el formulario para registrar un nuevo evento en el sistema</p>
            </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" id="fecha_inicio" name="fecha_inicio" class="form-control" 
                                   value="<?php echo htmlspecialchars($defaults['fecha_inicio']); ?>" 
                                   required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" id="fecha_fin" name="fecha_fin" class="form-control" 
                                   value="<?php echo htmlspecialchars($defaults['fecha_fin']); ?>">
